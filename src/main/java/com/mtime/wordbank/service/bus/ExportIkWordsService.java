 ...
 */
@Service
public class ExportIkWordsService {
     ...
     * @throws Exception
     */
    public void importPersonName() throws Exception {
     ...
     * @throws Exception
     */
    public void importMovieTitle() throws Exception {
     ...
     * @throws Exception
     */
    public void importMovieKeyWords() throws Exception {
     ...
     * @throws Exception
     */
    public void importDirectorAndActorWords() throws Exception {
